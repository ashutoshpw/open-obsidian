...
| `bun run audit:electron-vault` | Launches the local Electron shell against a disposable existing vault, verifies mediated open/read/write and a fresh-process reopen; reference Obsidian, other-platform interactive runs and human validation remain pending. |
