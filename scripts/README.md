...
| `bun run audit:plugin-lifecycle` | Runs a synthetic marker-free onload/onunload trace and a synthetic privileged-DOM denial in the Electron renderer wrapper; unchanged plugin lifecycle, cross-platform enforcement and reference behavior remain pending. |
