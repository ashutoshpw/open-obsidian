export {DEFAULT_WORKSPACE_VISIBILITY, WORKSPACE_BLOCKS, workspaceBlock, workspaceColumns, type SharedWorkspaceAction, type WorkspaceBlock, type WorkspaceBlockId, type WorkspaceVisibility} from "./workspace.js";
