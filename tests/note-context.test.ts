...
test("note context exposes outline, outgoing links and resolved backlinks without vault writes", () => {
  ...
  expect(context.outgoingLinks).toEqual([
    {target: "two", resolvedPath: "two.md", status: "resolved", candidates: ["two.md"], line: 5, text: "See [[two]] and [missing](missing.md)."},
    {target: "missing.md", status: "unresolved", candidates: ["missing.md"], line: 5, text: "See [[two]] and [missing](missing.md)."},
  ]);
